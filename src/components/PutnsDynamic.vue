<!--/putns/1 -> /putns/40 folders. It will choose which images to display 
dynamically based on routerId.

This Component DEPENDS on Putns.vue component. More specifically the :id section so it can choose
putns1-40 folder. -->
